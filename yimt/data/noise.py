...
class WordDropout(Noise):
    ...
    Example:
      ...
      >>> noise = yimt.data.WordDropout(0.5)
...
class WordOmission(Noise):
    ...
    Example:
      ...
      >>> noise = yimt.data.WordOmission(1)
      >>> words = tf.constant(["a", "b", "c"])
      >>> noise(words).numpy()
...
class WordReplacement(Noise):
    ...
    Example:
      ...
      >>> noise = yimt.data.WordReplacement(0.5)
      >>> words = tf.constant(["a", "b", "c"])
      >>> noise(words).numpy()
...
class WordPermutation(Noise):
    ...
    Example:
      ...
      >>> noise = yimt.data.WordPermutation(3)

...
def create_trans(parent):
    ...
    entry_choose=tk.Entry(parent, textvariable = path,width=50).grid(row=0,column=1,padx=10, pady=5)
    ...
    choose_slanguage.grid(row=2,column=1,padx=10, pady=5)
    choose_slanguage["value"]=("中文","英文","韩文","日文")
    ...
    choose_tlanguage.grid(row=3,column=1,padx=10, pady=5)
    choose_tlanguage["value"]=("中文","英文","韩文","日文")
    #选择翻译api
    ...
    button_start.grid( row=10,column=0,padx=10, pady=5)
    button_exit = tk.Button(parent, text="关闭", command=parent.quit)
    button_exit.grid(row=10, column=1,padx=10, pady=5)
...
def create_sarcebleu_trans(parent):
    ...
    tk.Label(parent, text="tokenize").grid(row=2, column=0, padx=10, pady=5, sticky="e")
    tokenize_choose = ttk.Combobox(parent,textvariable=tokenize_get)
    tokenize_choose .grid(row=2, column=1, padx=10, pady=5)
    ...
    button_start = tk.Button(parent, text="计算bleu",
                             command=go)
    button_start.grid(padx=5,pady=10, row=10,column=0 )
    button_exit = tk.Button(parent, text="关闭", command=parent.quit)
    button_exit.grid(row=10,pady=10,padx=5,column=1)